...
completion = client.chat.completions.create(
  ...
  messages=[
    ...
    {
      "role": "system",
      "content": "다음 데이터를 기반으로 향후 6개월 간의 환율 전망을 제공해주세요. 전망은 월별로 명확하게 제시하고, JSON 형식으로 제공해 주세요.  ex {2024: {1월: 620.12, 2월: 610.89, 3월: 605.67, 4월: 600.45, 5월 : 595.22, 6월: 590.00}"
    }  
  ]
)
