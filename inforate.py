...
while True:
    ...
    if user_input2 == "no":
       False
        ...
        ax.plot(year, rate_1, color = 'red', label = country[0], marker = 'o')
        ax.plot(year, rate_2, color = 'blue', label = country[1], marker = 'o')
        ax.plot(year, rate_3, color = 'green', label = country[2], marker = 'o')
        ax.plot(year, rate_4, color = 'yellow', label = country[3], marker = 'o')
        ax.plot(year, rate_5, color = 'orange', label = country[4], marker = 'o')
